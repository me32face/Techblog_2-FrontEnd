      ...
      <div className="footer-container-techblog">
        ...
        <div className="footer-social-techblog">
          ...
          <div className="footer-icons-techblog">
            <a href="https://portfolio-akshay-244.vercel.app/" target="_blank" rel="noopener noreferrer" title="Portfolio">
              <i className="fas fa-user-circle"></i>
            </a>
            <a href="https://www.instagram.com/ak.s_hey" target="_blank" rel="noopener noreferrer" title="Instagram">
              <i className="fab fa-instagram"></i>
            </a>
            <a href="mailto:akshay.anilkumar244@gmail.com" title="Email">
